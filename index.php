...
<link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/logo1.png">
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p style = "text-align: center;">Get Around The City For Less. If You Find a Better Price, We'll Match It! Wander Wisely.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Explore Now</a></li>
        </ul>
      </div>
...
<?php }}?>
  ...
  <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">View More</a></li>
        </ul>
      </div>
</section>
<!-- /Resent Cat --> 
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/12.jpg" alt="" /> </div>
